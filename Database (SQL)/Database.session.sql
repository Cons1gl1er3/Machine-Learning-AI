CREATE TABLE employee (
    ...
    birth_date DATE CHECK(birth_date LIKE "____-__-__"),
    sex VARCHAR(1),
    salary INT,
    super_id INT,
    branch_id INT
...
CREATE TABLE branch (
    ...
    mgr_id INT,
    mgr_start_date DATE CHECK(mgr_start_date LIKE "____-__-__")
);
...
CREATE TABLE works_with (
    ...
    client_id INT,
    total_sales INT,
    CONSTRAINT PRIMARY KEY(emp_id, client_id)
);
...
-- Union
SELECT first_name AS col1, last_name AS col2
FROM employee
UNION
